...
namespace Metodos_de_classes
{
    ...
    internal class Program
    {
        ...
        {
            ContaBancaria contaDoJoao = new ContaBancaria("12345", "Joao Santos");

            double valorSacado = contaDoJoao.Sacar(10, "12345");
            contaDoJoao.Depositar(1000);
            contaDoJoao.ConsultaSaldo("12345");
            valorSacado = contaDoJoao.Sacar(10, "12345");

            ContaBancaria contaDoFranciso = new ContaBancaria(1000, "54321", "Francisco Silva");

            double valorSacado1 = contaDoFranciso.Sacar(10, "54321");
            contaDoFranciso.Depositar(1000);
            contaDoFranciso.ConsultaSaldo("54321");
            valorSacado1 = contaDoFranciso.Sacar(10, "54321");
        }
    }
}
