...
namespace Filas_e_pilhas
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            FilaDeNomes.Enqueue("Susana");
            FilaDeNomes.Enqueue("Nilson");
            FilaDeNomes.Enqueue("Bruna");
            ...
            //Adicionando elementos
            PilhaDeNomes.Push("Marcio");
            PilhaDeNomes.Push("Pedregunda");
            PilhaDeNomes.Push("João");
            PilhaDeNomes.Push("Allana");
