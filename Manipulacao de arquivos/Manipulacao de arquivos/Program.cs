...
namespace Manipulacao_de_arquivos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Primeiro método
            string caminho1 = "C:\\Users\\tigot\\Desktop\\GitHub Tiago\\PUBLICO\\CSharp-DotNet\\Manipulacao de arquivos\\teste.txt";
            //Segunda maneira
            string caminho2 = @"C:\Users\tigot\Desktop\GitHub Tiago\PUBLICO\CSharp-DotNet\Manipulacao de arquivos\teste.txt";
            ...
            string caminho3 = @"C:\Users\tigot\Desktop\GitHub Tiago\PUBLICO\CSharp-DotNet\Manipulacao de arquivos\teste2.txt";
            FileStream meuArquivo2 = File.Create(caminho3);
            meuArquivo2.Close();
            string caminho4 = @"C:\Users\tigot\Desktop\GitHub Tiago\PUBLICO\CSharp-DotNet\Manipulacao de arquivos\teste3.txt";
            File.Move(caminho3, caminho4);

            File.Delete(caminho4);

            //Escrevendo em um arquivo de texto
            string caminho5 = @"C:\Users\tigot\Desktop\GitHub Tiago\PUBLICO\CSharp-DotNet\Manipulacao de arquivos\nomes.txt";
